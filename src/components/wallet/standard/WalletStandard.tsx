...
import { /* mojo_to_kiwi_string, */ kiwi_to_mojo } from '../../../util/kiwi';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_kiwi_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of kiwi in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Kiwi that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Kiwi that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send kiwi to coloured address. Please enter a kiwi
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'kiwi_addr://') {
    ...
    const amountValue = Number.parseFloat(kiwi_to_mojo(amount));
    const feeValue = Number.parseFloat(kiwi_to_mojo(fee));
